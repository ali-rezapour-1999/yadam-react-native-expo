...
const ActiveIcon = ({ focused }: ActiveIconProps) => {
  ...
  return (
    <Svg width="32" height="32" viewBox="0 0 24 24" fill="none">
      ...
      />
      <Path d="M6.14697 14.0231L9.30353 9.92155L12.9041 12.748L15.9932 8.76144" stroke={focused ? Colors.main.button : Colors.main.border} strokeWidth="1.58197" strokeLinecap="round" strokeLinejoin="round" />
